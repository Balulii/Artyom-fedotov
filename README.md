# 👋 Привет! Я — Артём, начинающий QA Engineer

Добро пожаловать в мое портфолио!  
Здесь собраны мои практические работы по тестированию — от баг-репортов до автотестов.
...
- ⚙️ Практикую автоматизацию на Python (Selenium)  
- 🔍 Внимание к деталям — мой главный инструмент  
- 🚀 Учусь каждый день и иду в сторону Middle QA

📫 [LinkedIn](https://www.linkedin.com/in/artsiomrusau/) | [Telegram](https://t.me/artsiom_qa) | [Email](mailto:qa.rusau@gmail.com)

---

## 🧰 Инструменты, которые я использую

### 📁 Документация и тест-менеджмент:
...
<div>
  ...
  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Bash_Logo_Colored.svg/1024px-Bash_Logo_Colored.svg.png?20180723054350" width="24" title="Bash"/>
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vscode/vscode-original.svg" width="24" title="VS Code"/>
</div>

---

## ✨ Изюминка: «Лаборатория тестов»

Внутри этого репозитория — как мини-лаборатория:
- 📂 `manual-testing/` — чек-листы, баг-репорты, тест-кейсы  
- 🧪 `automation/` — автотесты на Python + Selenium  
- 📄 `docs/resume.md` — резюме в markdown-формате  
- ⚡ Всё структурировано, оформлено и готово к использованию

---

## 🚀 Планы на развитие:

- 🔧 Перейти на Playwright + Pytest  
- 📈 Настроить Allure-отчеты и GitHub Actions  
- 🧩 Изучить нагрузочное тестирование  
- 💬 Прокачать навыки API и WebSocket тестирования

---

> _«Хороший тестировщик не ломает — он помогает находить точки роста продукта»._  
> — Артём
